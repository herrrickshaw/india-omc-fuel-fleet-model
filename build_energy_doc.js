...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      h1("Annex A — The CBG incentive stack"),
      p("Compiled from the official GOBARdhan important-circulars register (gobardhan.eil.co.in, 70 circulars as of July 2026), cross-checked against the primary gazette for the fertiliser leg (CG-DL-E-29032025-262118). The stack de-risks every leg of the CBG business model — feedstock, capital, debt, gas revenue, digestate revenue, carbon revenue — and every rupee of it sits on-budget and ex-plant, the structural contrast with ethanol's hidden consumer-side funding documented in this paper. Roughly half the register is dated 2025-26: the policy cadence is accelerating."),
      table(
        ["Lever", "Instrument (issuer, date)", "What it provides"],
        [
          ["Offtake & pricing", "SATAT assured procurement (MoPNG, May-2022; methodology & price revision May-2025)", "OMCs guarantee CBG offtake at an assured ex-plant price (₹54/kg basis, excl. 5% GST) under long-term agreements"],
          ["", "CBG–CGD Synchronization Scheme (MoPNG, Apr-2021; extended Oct-2023, Mar-2026)", "CBG injected into city-gas networks, fungible with natural gas — grid sale instead of trucking"],
          ["", "CBG Blending Obligation (MoPNG, Feb-2024)", "Mandatory 1% CBG in CNG(T)/PNG(D) from FY25-26, stepping toward ~5% by FY28-29 — demand by decree"],
          ["Capital support", "MNRE Waste-to-Energy / National Bioenergy Programme (Nov-2022; revised Jun-2025; suppl. budget Sep-2025)", "Central financial assistance per unit of CBG capacity, capped per project"],
          ["", "SBM 2.0 bio-methanation VGF (MoHUA, cost norms revised Nov-2025)", "Viability-gap funding for municipal-waste CBG plants"],
          ["", "SASCI 2026-27 (DoF Mar-2026; MoPNG guidelines May-2026)", "Special capital assistance to states tied to CBG-sector reforms — the newest money in the register"],
          ["Infrastructure & feedstock", "Pipeline Infrastructure (DPI) scheme (MoPNG, 2024; amended Jan-2025, revised Aug-2025, extended Feb-2026)", "Funds the connecting pipeline from plant to the CGD grid — the offtake bottleneck"],
          ["", "Biomass Aggregation Machinery scheme (MoPNG, Feb-2024; revised Jul-2025)", "Assistance for paddy-straw / biomass collection machinery"],
          ["", "Crop Residue Management guidelines (DA&FW, 2023-24)", "Channels crop stubble to CBG plants as feedstock"],
          ["Fertiliser (digestate) leg", "FCO amendments: FOM Jul-2020, LFOM May-2021, 2023 relaxations → Schedule VIII 'Organic Carbon Enhancer' (DA&FW, Feb/Mar-2025)", "Digestate becomes a notified fertiliser; Schedule VIII defined on organic carbon (12–14%) + heavy metals only — no NPK/C:N/sieve, built so CBG digestate passes"],
          ["", "Bulk Sale Notifications I–VII (DA&FW, Nov-2023 → Feb-2026)", "Named plants may sell FOM/LFOM in bulk directly to farmers for 3 years, bypassing dealer licensing"],
          ["", "Market Development Assistance (DoF, Sep-2023 + SOP/iFMS/DBT machinery 2024-25)", "~₹1,500/tonne support on FOM/LFOM/PROM sold — a per-tonne digestate subsidy"],
          ["", "ICAR Package of Practice (DARE/ICAR, Jul-2024)", "Official agronomic guidance legitimising FOM/LFOM use on crops"],
          ["Finance access", "Priority Sector Lending (RBI, Sep-2020)", "CBG plants qualify for mandated, cheaper bank credit"],
          ["", "Agriculture Infrastructure Fund (Oct-2020; guidelines Jan-2023) · AHIDF (DAHD, Apr-2022)", "Interest subvention + credit guarantee; dung-based plants eligible under the animal-husbandry fund"],
          ["Tax & carbon", "5% GST on CBG · excise exemption on CBG-blended CNG (Feb-2023 budget)", "Light single tax; the blended portion is not taxed twice"],
          ["", "Carbon-credit eligibility (MoEFCC, Feb-2023)", "CBG plants can monetise credits under the Paris-Agreement framework — a third revenue leg"],
          ["Standards & regulatory easing", "IS 16087:2025 Bio-CNG specification (Aug-2025) · MoRTH bio-CNG fuel notification (Jun-2015) · CPCB re-categorisation (2021, 2025)", "Legal fungibility with CNG (the basis of energy parity per kg), automotive-fuel authorisation, friendlier pollution-control classification"],
          ["State layer", "UP 2022 · Bihar 2023/2025 · Rajasthan & AP 2024 · Assam 2025 · MP Apr-2025 · Chhattisgarh Jul-2026 · Model State CBG Policy (MoPNG, Apr-2026)", "Capital-subsidy top-ups, land, stamp-duty and electricity-duty waivers; the model policy gives states a template"],
        ],
        [1900, 4300, 3600], true),
      spacer(),
      p("Caveats: scheme amounts (capital-assistance rates, MDA quantum) are periodically revised — the register dates above identify the governing circular to check; the NCDC cooperative-mill route nominally covers biogas-adjacent assets but is 96.5% working capital in practice (Section 8); and state-policy benefits vary widely in generosity and actual disbursement.", { size: 18, color: MUTE, italics: true }),
